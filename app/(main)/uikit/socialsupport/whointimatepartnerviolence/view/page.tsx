...
const SocialSupportView = () => {
                        ...
                        <ul className="p-0 mx-0 mt-0 mb-4 list-none">
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.insulted_feelings}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.belittled_humiliated}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                   3.  Done things to scare or intimidate you on purpose
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.scare_intimidate}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.threw_out_house}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.confined_locked}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.threatened_hurt}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.slapped_thrown}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.pushed_dhoved}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.hit_with_fist}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.kicked_dragged}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.choked_burnt}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.threatened_used_weapon}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                13. Force you to have sexual intercourse by threatening you, holding you down or hurting you in some way?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.forced_sexual_Intercourse}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                14. Did you ever agree to have intercourse when you did not want to because you were afraid of what your husband/partner might do if you refused?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.agreed_unwanted_Intercourse}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                15. Force you to do something sexual (besides vaginal intercourse) that you did not want to do?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.forced_other_sexual_act}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.tried_keep_from_friends}</span>
                                </span>
                            </li>
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                16. Tried to keep you from seeing your friends?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.tried_restrict_family_contact}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                17. Tried to restrict contact with your family of birth?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.insisted_knowing_location}</span>
                                </span>
                            </li>
 ...
 you to have sexual intercourse by threatening you, holding you down or hurting you in some way?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.suspicious_unfaithful}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                21. Took your earnings or savings against your will?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.took_earnings_savings}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.refused_money_for_household}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                <span className="text-900 line-height-3">
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.tried_convince_crazy}</span>
                                </span>
                            </li>
                            <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                                ...
                                24. Blamed you for causing their violent behaviour?
                                    ...
                                    <span className="text-blue-500">{ }  {socialSupport.blamed_for_violent_behavior}</span>
                                </span>
                            </li>
