...
const CaseReviewView = () => {
    ...
    const fetchCaseReview = async (userId: any) => {

        try {
            await api.getEntry("CaseReview", userId, "3").then((data: any) => {
    ...
    const onSelectedIntervention = () => {
        router.push('/uikit/CaseReview/view/')
    }
    ...
    return (
        <>
            <Accordion activeIndex={0}>
                ...
                >
                    {CaseReview.map((data: any, index: any) => (
