...
const Inpatientcare: Page = () => {
    ...
    const saveInpatientcare = (event: any) => {
    ...
    return (
        <div>
            <div className="card ">
                <form onSubmit={saveInpatientcare} >
                    <h5>Inpatient Care</h5>
                    <p>I would now like to know about your recent experiences with obtaining health care. Following questions will be about your inpatient care which you have received in the last year.</p>
                </form>
            </div>
        </div>
