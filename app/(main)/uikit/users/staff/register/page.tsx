...
const RegisterUser1 = () => {
    ...
    const showFailed = (staff_no: any, phone_no: any) => {
        toast.current?.show({
            severity: 'error',
            summary: 'Failure Message',
            detail: `Staff Number : ${staff_no} or Phone Number ${phone_no} Already in Use `,
            life: 10000
        });
    ...
    const saveUserDetails = async (event: any) => {
        ...
        try {
            console.log('try ---')
            console.log(useDetails)
            await api.addEntry('user/staff', useDetails, 3).then(user => {
                console.log("the data is not here :: ", user)
                if (user.data.field_exists) {
                    showFailed(user.data.staff_number, user.data.phone_number)
                    ...
                    setTimeout(() => {
                        ...
                        router.push('/uikit/users/staff/view')
                    }, 4000);
                    ...
                    <form onSubmit={saveUserDetails}>
                        <div className="p-fluid formgrid grid">
                            ...
                            <div className="field col-12 md:col-6">
                                ...
                                <InputText name="phone_number" value={useDetails.phone_number} onChange={onchaneUserDetails} type="number" required />
                            </div>
                            <div className="field col-12 md:col-6">
